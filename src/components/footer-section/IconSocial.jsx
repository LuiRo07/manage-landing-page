...
function IconSocial() {
  return (
    <ul className="flex justify-between sm:justify-around px-4 gap-8">
        {/* facebook */}
        <li>
        ...
        {/* youtube */}
        <li>
            <svg className="hover:fill-primary-red fill-white cursor-pointer" xmlns="http://www.w3.org/2000/svg" width="21" height="20">
        ...
        {/* twitter */}
        <li>
            <svg className="hover:fill-primary-red fill-white cursor-pointer" xmlns="http://www.w3.org/2000/svg" width="21" height="18">
